    ...
    static Stream<TestParsingData> testParsingData() {
        ...
        return Stream.of(
                new TestParsingData("Point",
                        pointResponse,
                        FindLocationResult.createFoundResult(Collections.singletonList(new Location(-34.407, 150.88001, 0.0, Instant.ofEpochSecond(10))), Collections.emptyList(), pointResponse)),
                new TestParsingData("Circle",
                        cicleResponse,
                        FindLocationResult.createFoundResult(Collections.singletonList(new Location(-34.407, 150.88001, 30.0, Instant.ofEpochSecond(10))), Collections.emptyList(), cicleResponse)),
                ...
                new TestParsingData("ResultWithAmlData",
                        ...
                        FindLocationResult.createFoundResult(Collections.singletonList(new Location(-34.407, 150.88001, 0.0, Instant.ofEpochSecond(10),
                                ...
                                Collections.emptyList(), amlData)),
                new TestParsingData("Multiple locations",
                        multipleLocations,
                        FindLocationResult.createFoundResult(Arrays.asList(new Location(-34.407, 150.88001, 30.0, Instant.ofEpochSecond(10)), new Location(-34.407, 150.88001, 0.0, Instant.ofEpochSecond(10))), Collections.emptyList(), multipleLocations)),
                new TestParsingData("ResultWithAmlDataAndUnparsablePositioningMethod",
                        ...
                        FindLocationResult.createFoundResult(Collections.singletonList(new Location(-34.407, 150.88001, 0.0, Instant.ofEpochSecond(10),
                                ...
                                Collections.emptyList(), amlDataUnparsablePositioningMethod))
        );
    }
